...
void Glow::ReadInfo(){ 
	...
	ReadProcessMemory(fProcess.__HandleProcess, (PBYTE*)(O.local + 0x2), &LocalPlayer, sizeof(int), NULL); // Gets LocalPlayer
	ReadProcessMemory(fProcess.__HandleProcess, (PBYTE*)(LocalPlayer), &LocalPlayer, sizeof(int), NULL); // Gets LocalPlayer
	ReadProcessMemory(fProcess.__HandleProcess, (PBYTE*)(O.dwGlowObject + 0x3), &GlowObject, sizeof(int), NULL); // Gets GlowObject
	ReadProcessMemory(fProcess.__HandleProcess, (PBYTE*)(GlowObject), &GlowObject, sizeof(int), NULL); // Gets GlowObject
